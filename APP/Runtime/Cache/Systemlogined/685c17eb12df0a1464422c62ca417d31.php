							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
										<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
										 ...
										 <td><?php echo ($v["id"]); ?></td>
                                         <?php if($v['datatype'] == 'cslkb'): ?><td><?php echo ($v["g_user"]); ?></td>
											 <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['g_user']));?>"><?php echo ($v["g_id"]); ?></a></td>
                                            
                                         <?php else: ?>
                                         	   <td><?php echo ($v["p_user"]); ?></td>
											   <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['p_user']));?>"><?php echo ($v["p_id"]); ?></a></td><?php endif; ?>
                                         
                                         
										 
                                         
                                         
										<td><?php echo group($v[p_level]);?>
										</td>
										<td><?php echo ($v["lkb"]); ?></td>
										<td><?php echo ($v["jb"]); ?></td>
										<?php if($v['datatype'] == 'cslkb'): ?><td><?php echo ($v["p_user"]); ?></td>
											 <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['p_user']));?>"><?php echo ($v["p_id"]); ?></a></td>
                                            
                                         <?php else: ?>
                                         	   <td><?php echo ($v["g_user"]); ?></td>
											   <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['g_user']));?>"><?php echo ($v["g_id"]); ?></a></td><?php endif; ?>
                                        
                                        <td><?php echo group($v[g_level]);?></td>
                                        
										<td><?php echo ($v["jydate"]); ?></td>
										<td><a href="<?php echo ($v["imagepath"]); ?>" target="_blank"><img src="<?php echo ($v["imagepath"]); ?>"  style="width:40px;"/></a></td>										
