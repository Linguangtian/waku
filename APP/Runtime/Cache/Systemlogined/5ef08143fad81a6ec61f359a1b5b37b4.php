										...
										<div id="home" class="tab-pane in active">
                                           ...
                                           <div class="control-group" style="display:none;">
											...
											<div class="control-group" style="display:none;">
												...
												<div class="control-group" >
													<label class="control-label" for="tjj">团队算力加成</label>

													<div class="controls">
														一级<input type="text" id="sljc_1" name="sljc_1" value="<?php echo ($config["sljc_1"]); ?>" style=" width: 100px;" class="span3"/>%&nbsp;&nbsp;
														二级<input type="text" id="sljc_2" name="sljc_2" value="<?php echo ($config["sljc_2"]); ?>" style=" width: 100px;" class="span3"/>%&nbsp;&nbsp;
														三级<input type="text" id="sljc_3" name="sljc_3" value="<?php echo ($config["sljc_3"]); ?>" style=" width: 100px;" class="span3"/>%&nbsp;&nbsp;
													</div>
												</div>
											...
											<p>
												<form class="form-horizontal" action="<?php echo U(GROUP_NAME.'/System/transferConf');?>" method="post">
													...
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" id="transfer_min" name="transfer_min" value="<?php echo ($config["TRANSFER_MIN"]); ?>" class="span3"/><span class="help-inline">每次转账最少额度</span>
														</div>
													</div>
													...
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" id="transfer_tax" name="transfer_tax" value="<?php echo ($config["TRANSFER_TAX"]); ?>" class="span3"/><span class="help-inline">设置转账的时候要扣除的手续费即x%</span>
														</div>
													</div>
                                                    ...
                                                    <div class="control-group">
														...
														<div class="controls">
                                                        	<select name="recharge_type">
                                                            	<option value="1" <?php if($config['recharge_type'] == 1): ?>selected="selected"<?php endif; ?>>微信</option>
                                                                <option value="2" <?php if($config['recharge_type'] == 2): ?>selected="selected"<?php endif; ?>>支付宝</option>
                                                            </select>
