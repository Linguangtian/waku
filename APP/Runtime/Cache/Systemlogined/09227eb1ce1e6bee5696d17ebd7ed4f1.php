					...
					<div class="row-fluid">
						...
						<form id="table-searchbar" method="POST" class="form-inline well well-small">
							<div class="row-fluid">&nbsp;&nbsp;用户编号 
				                <input type="text" class="input-small" name="li_username" value="<?php echo $_POST['li_username'];?>">    
		                        &nbsp;&nbsp;
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
											<td><?php echo ($v["id"]); ?></td>
											<td><a target="_blank" href="<?php echo U('inMember',array('u'=>$v['username']));?>"><?php echo ($v["mobile"]); ?></a></td>							
                                            ...
                                            <td><a href="<?php echo ($v["alipay_voucher"]); ?>" target="_blank"><img src="<?php echo ($v["alipay_voucher"]); ?>" width="50" height="80"></a></td> 
											<td><a href="<?php echo U(GROUP_NAME .'/Member/chekuser',array('id'=>$v['id']));?>">查看审核</a> | <a onclick="if(confirm('删除后不可恢復！您确定要删除此会员吗?')==false)return false;" href="<?php echo U(GROUP_NAME .'/Member/deleteMember',array('id'=>$v['id']));?>">删除</a></td>
