							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
										<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
										 ...
										 <td><?php echo ($v["id"]); ?></td>
										<td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['g_user']));?>"><?php echo ($v["g_user"]); ?></a></td>
										...
										<td><?php echo ($v["jb"]); ?></td>
										 <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['p_user']));?>"><?php echo ($v["p_user"]); ?></a></td>
										<td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['p_user']));?>"><?php echo ($v["p_id"]); ?></a></td>
										<td><?php echo group($v[g_level]);?>
										</td>
