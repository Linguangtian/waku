...
<script type="text/javascript">
	$(function() {
				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addSonHandle"  action="<?php echo U(GROUP_NAME .'/Shop/addSonHandle');?>" method="post">
								<div class="control-group">
									<label class="control-label" for="name"> 分类名称</label>

									<div class="controls">
										<input type="text" value="" name="name" id="name" placeholder="添加子分类" />
									</div>
								</div>
		...
		<!--basic scripts-->
		<script type='text/javascript'>
			var checkTypeName = "<?php echo U(GROUP_NAME.'/Shop/checkTypeName');?>";
		</script>
		...
		$('form[name="addSonHandle"]').validate({
					//默认为lable
					errorElement : 'span',
					//失败时先移除成功的class
					validClass : 'success',
