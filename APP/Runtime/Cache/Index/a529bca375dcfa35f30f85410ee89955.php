...
<div style=" width:100%; margin:10px auto; text-align:center;">
	<a href="<?php echo U('Index/Account/myAccount');?>" class='aall' style="margin-right:10px;">我的工会</a>
    <a href="<?php echo U('Index/Account/memberAccount');?>" class='aall foncus'>工会管理</a>
...
<?php else: ?>
	...
	<table style="width: 90%;margin-left: 5%;color: #333333;border-collapse:collapse;">
       ...
       <tr>
		...
		<tr>
        	<td colspan="2" align="center"><input type="button" value="提交" class="mysub" style=" width:60%; height:35px; padding:3px 10px; border:0px; border-radius:4px; background:#87CEEB; color:#ffffff;"></td>
