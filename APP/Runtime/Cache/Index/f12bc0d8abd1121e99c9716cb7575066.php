...
<div class="zhul" style="padding-bottom:5px;margin-bottom:80px">
 ...
 <?php if(is_array($orders)): foreach($orders as $key=>$v): ?><tr style="text-align:center">
                ...
                <?php if($v['zt'] == 1): ?><a href="javascript:;"  <?php if($v['is_jiesuan'] == 0): ?>class="huibtn"<?php endif; ?> onClick="jiesuan(<?php echo ($v["id"]); ?>)" style="padding:3px 5px; background:#87CEEB; color:#FFFFFF; border-radius:4px;">点击结算收益</a>
                <?php else: ?>
                	---<?php endif; ?>
