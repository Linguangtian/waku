...
<div style="width: 90%;margin-left: 5%;float: left;margin-top: 50px">
    ...
    <div style="text-align: center;position: relative;width: 100%;height: 100%;height: 100%;">
        ...
        <!-- <img class="quan" src="__PUBLIC__/web/img/2.png" alt=""style="width:56%;position: absolute;top: 22%;left: 22%;z-index: 50;"/> -->
	...
	<div style=" position:fixed; bottom:60px;">
		<p  style="margin-top:-20px;height: 30px;line-height: 30px;font-size:12px;"><span id="drGEC" style="font-size:3em;color:#fff"><?php echo ($jrsy); ?></span>&nbsp;&nbsp;&nbsp;CHB</p>
		<p  style="height: 30px;line-height: 30px;color:#fff;margin-top:10px;">矿机算力：<span><?php echo ($gonglv); ?></span>&nbsp;GH/s</p>
		<p style="height: 30px;line-height: 30px;font-size:12px;color:#aaa;">累计获得：<span id="ljGEC"><?php echo ($total_sy); ?></span>&nbsp;CHT</p>
		<p  style="height: 30px;line-height: 30px;font-size:12px;color:#aaa;">全网总算力：<span><?php echo ($qwsl); ?></span>&nbsp;GH/s</p>
	    <!-- <p  style="height: 30px;line-height: 30px;font-size:10px;color:#aaa;">全网总产量：<span><?php echo ($data_b_total); ?></span>&nbsp;CHT</p> -->
	</div>
</div>
