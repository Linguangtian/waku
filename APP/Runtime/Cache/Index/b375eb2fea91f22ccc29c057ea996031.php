...
<!--顶部结束-->
  ...
  <ul style="width:90%;padding-top:15%;margin-left:5%">
		...
		<li style="width:50%;float:left;text-align:center;color:#ffffff;background-color:#87CEEB;height: 30px;line-height: 30px;"><a style="color:#ffffff" href="<?php echo U('Index/msg/addmsg');?>" >在线留言</a></li>
...
<div style="width:80%; margin:5px auto;">
	...
	<h3>标题</h3>
		...
		<input type="submit" value="提交" style="width:100%;border-radius:5px;height:30px;background-color:#87CEEB;border:0px; margin-top:10px; color:#ffffff;"/>
	</form>
</div>    
	<!-- 上传图片 -->
	<script>
