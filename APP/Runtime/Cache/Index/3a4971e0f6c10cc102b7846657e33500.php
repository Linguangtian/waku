...
<input id="btnback" class="buttom" onclick="javascript:window.history.go(-1)" type="button"value="返 回" style=" width:80%; border-radius:4px; padding:5px 10px; border:0px; background:#4169E1; color:#ffffff;"/>
</div>
