...
<body style="background-color: #eee">
	...
	<span style="font-size:14px;text-align:center;color:#FFA500;margin-left:8%">温馨提示：由于涉及转账交易，手机号码与支付宝账号必须一致，且真实有效！</span>
	...
	<form action="" id="myform" method="post"style="margin-top:20px">
		...
		<div style=" margin: 0 auto;width: 94%;background: #fff;border: 1px solid #e3e3e3;border-radius: 5px;">
			...
			<div class="code" style="margin-left: 5%;width: 95%; height: auto;border-bottom: 1px solid #e3e3e3;padding: 10px 0 10px;">
				...
				<span class="fr" id="count_down" onClick="send_sms_reg_code()" style="background-color: #87CEEB;display: inline-block;width: 35%;text-align: center;font-size: 1em;padding: 0px 0 0px;border-radius: 5px">发送验证码</span>
			</div>
			...
			<div style="margin-left: 5%;width: 95%; height: auto;border-bottom: 1px solid #e3e3e3;padding: 10px 0 10px;">
				交易密码：<input type="password" placeholder="请输入交易密码" required name="password2" style="width: 70%;color: #999999;font-size: 1em;-webkit-appearance: none;border: none;outline: medium;">
			</div>
			<div style="margin-left: 5%;width: 95%; height: auto;border-bottom: 1px solid #e3e3e3;padding: 10px 0 10px;">
			  	确定密码：<input type="password" placeholder="确定交易密码" required  name="password21" style="width: 70%;color: #999999;font-size: 1em;-webkit-appearance: none;border: none;outline: medium;">
			</div>
			<input type="hidden" name="parent" id="parent" value="<?php echo ($uid); ?>"/>
		</div>
		...
		<button type="button" id="submit" class="btn_submit_my" style="margin-left: 5%;width: 90%;height: 2.5em;line-height: 2.5em;font-size: 1em;letter-spacing: 1px;text-align: center;color: #fff;border-radius: 5px;-webkit-border-radius: 5px;-moz-border-radius: 5px;background-color: #87CEEB;border: 0; margin-bottom:15px;">注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;册</button>
